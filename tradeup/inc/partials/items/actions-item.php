 ...
 */
	...
	// Overlay
	if( ! function_exists( 'tu_ext_item__actions_overlay' ) ) {
		function tu_ext_item__actions_overlay( $widget_options ) {
			...
			$output   = apply_filters( 'tu_ext_item___actions_overlay', $output, $format, $widget_options );
	...
	// Container
	if( ! function_exists( 'tu_ext_item__actions_container' ) ) {
		function tu_ext_item__actions_container( $widget_options ) {
			/**
			 * Hooked:
			 * tu_ext_item__actions_container_start       - 10
			 * tu_ext_item__actions_container_image       - 20
			 * tu_ext_item__actions_container_meta        - 30
			 * tu_ext_item__actions_container_end         - 999
			 */
			do_action( 'tu_ext_item__actions_container', $widget_options );
		}
	}

		// Container start
		if( ! function_exists( 'tu_ext_item__actions_container_start' ) ) {
			function tu_ext_item__actions_container_start( $widget_options ) {
				?><div class="grid-container grid-1 clearfix <?php tradeup_anim_classes(); ?>"><?php
			}
		}

		// Container end
		if( ! function_exists( 'tu_ext_item__actions_container_end' ) ) {
			function tu_ext_item__actions_container_end( $widget_options ) {
				?></div><!-- END .grid-container --><?php
			}
		}

		// Image
		if( ! function_exists( 'tu_ext_item__actions_container_image' ) ) {
			function tu_ext_item__actions_container_image( $widget_options ) {
		...
		// Meta
		if( ! function_exists( 'tu_ext_item__actions_container_meta' ) ) {
			function tu_ext_item__actions_container_meta( $widget_options ) {
				/**
				 * Hooked:
				 * tu_ext_item__actions_container_meta_start       - 10
				 * tu_ext_item__actions_container_meta_title       - 20
				 * tu_ext_item__actions_container_meta_excerpt     - 30
				 * tu_ext_item__actions_container_meta_buttons     - 40
				 * tu_ext_item__actions_container_meta_end         - 999
				 */
				do_action( 'tu_ext_item__actions_container_meta', $widget_options );
			}
		}

			// Meta start
			if( ! function_exists( 'tu_ext_item__actions_container_meta_start' ) ) {
				function tu_ext_item__actions_container_meta_start( $widget_options ) {
					$image   = $widget_options['image'];
			...
			// Meta end
			if( ! function_exists( 'tu_ext_item__actions_container_meta_end' ) ) {
				function tu_ext_item__actions_container_meta_end( $widget_options ) {
					?></div><!-- END .elements-meta --><?php
				}
			}

			// Title
			if( ! function_exists( 'tu_ext_item__actions_container_meta_title' ) ) {
				function tu_ext_item__actions_container_meta_title( $widget_options ) {
			...
			// Excerpt
			if( ! function_exists( 'tu_ext_item__actions_container_meta_excerpt' ) ) {
				function tu_ext_item__actions_container_meta_excerpt( $widget_options ) {
					$excerpt  = $widget_options['excerpt'];
					$allowed  = $widget_options['allowed_html'];
					$format   = '<div class="elements-excerpt fs-large">%s</div>';

					$output = sprintf( $format, tradeup_ext_escape_content_filtered( $excerpt ) );
			...
			// Buttons
			if( ! function_exists( 'tu_ext_item__actions_container_meta_buttons' ) ) {
				function tu_ext_item__actions_container_meta_buttons( $widget_options ) {
					$excerpt         = $widget_options['excerpt'];
					$allowed         = $widget_options['allowed_html'];
